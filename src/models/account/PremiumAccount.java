...
public class PremiumAccount extends Account {
     ...
     */
    public PremiumAccount(String accountNumber, double balance, User owner, double higherLimit, double premiumRate)
    {
    ...
    public void withdraw(double value) {
        ...
        {
            System.out.println("Error Amount exceeds premium withdrawal limit of: " + higherLimit);
            return;
        }
        // Check if balance is sufficient
        if (value > getBalance())
        {
            System.out.println("Error Insufficient balance Available: " + getBalance());
            return;
        }
        // If all checks pass call the parent withdraw method
        super.withdraw(value);
        System.out.println("Premium withdrawal successful Remaining balance: " + getBalance());
    }
    /**
...
>>>>>>> f47e2ccc89243722539df8e13daf876a5acf6232
