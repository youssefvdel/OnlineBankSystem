...
public class StandardClient extends Client implements Insurable {
     ...
     * including basic banking services and withdrawal access
     * @return benefits as string
     */
    @Override
    public String getBenefits() {
        return "Standard Benefits: withdrawal limit = " + withdrawalLimit
                + ", basic account insurance, and access to daily banking services";
    }
