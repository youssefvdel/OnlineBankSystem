...
| :-: | ---------------- | ---------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|  1  | **Youssef Adel** | `258270`   | 🎯 **Team Lead** | • Account, BusinessAccount, CurrentAccount, BankSystem, Main<br>• GitHub Repository Management<br>• Project Planning & Management <br>• Class Diagram & OOP Logic Design |
